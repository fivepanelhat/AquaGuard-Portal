...
from portal_schemas.compliance import WaterOptimizationPlan, AerationAction, PumpAction, ValveAction
...
class AIAgent:
    ...
    def __init__(
        ...
        logger.info(f"AquaGuard AI Agent initialized. Target Model: {model} at {ollama_host}")
