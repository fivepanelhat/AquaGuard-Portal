...
class AquaGuardPortal:
        ...
        while self.is_running:
            try:
                ...
                record = ComplianceRecord(
                    ...
                    operator_notes=plan.get("logistical_notes", "Continuous edge telemetry analysis completed successfully.")
                )
    ...
    def _evaluate_compliance_status(self, metrics: dict) -> str:
        ...
        if do < limits.do_min:
            logger.warning(f"Dissolved oxygen critical limit breached: {do} (min {limits.do_min})")
            return "breach_critical"
